...
<p align="left">Я начинающий Backend разработчик. Мой путь в it начался с разработки игр на Unreal Engine 4. После я пробовал себя во многих направлениях, пробовал изучать язык C, Python, попробовал свои силы в cybersecurity, но больше всего меня зацепила Backend разработка! На данный момент я поставил себе цель за 3 года изучить Python, JavaScript, DevOps и многое другое. В перерывах от основного обучения планирую по чуть чуть изучать Unreal Engine 5 .В настоящий момент мое обучение на курсе завершено и я нашел свою первую работу!<br>- ⚡ Являюсь старшим студентом на курсе Информационные технологие и программирование.</p>
